...
model_dir = "models_dir"  #请将路径替换为实际模型目录路径
log_dir = r"logs_dir"  #请将路径替换为实际日志目录路径
patch_size = 32
batch_size = 32
learning_rate = 1e-4
num_epochs = 400
