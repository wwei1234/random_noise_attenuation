...
# === 你要绘制的文件路径列表 ===
file_list = [
    r"D:\桌面\项目\Stratton\data\d50_noise.npy",
    r"D:\桌面\项目\Stratton\data\d50.npy",
    r"D:\桌面\项目\Stratton\data\dn50.npy"
    # 如果还有其他文件，继续加
]
...
for i, file_path in enumerate(file_list):
    ...
    # # === 保存图像 ===
    # save_path = rf"D:\桌面\项目\shandong\可视化\{filename}_FK.png"
