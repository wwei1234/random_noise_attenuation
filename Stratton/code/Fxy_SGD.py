...
if __name__ == "__main__":
    ...
    np.save(r"D:\桌面\项目\Stratton\data\SGD_data.npy",data)
    np.save(r"D:\桌面\项目\Stratton\data\SGD_denoised.npy",denoised)
    np.save(r"D:\桌面\项目\Stratton\data\SGD_noise.npy",data - denoised)
