...
model = UNet()
model_path = r'D:\桌面\项目\shengbei\U_Net_N2N_711\model_epoch_200.pth'
...
# model_path = r'D:\桌面\项目\U_Net3+ 合成记录测试\开源数据集训练CODE\U_Net3+_model_4_10\model_epoch_20.pth'
# model.load_state_dict(torch.load(model_path, weights_only=True))
...
with torch.no_grad():
    ...
    res = marmousi_noisy - result

    np.save(r"D:\桌面\项目\shengbei\data\U-Net-711-200-denoised.npy",result)
    np.save(r"D:\桌面\项目\shengbei\data\U-Net-711-200-noise.npy",res)
