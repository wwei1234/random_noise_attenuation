...
# === 文件列表 ===
file_list = [
    r"D:\桌面\随机噪声压制\shandong\数据\fx_denoised_yxsn5cdpn.npy",
    # r"D:\桌面\随机噪声压制\shandong\数据\yxsn5cdpn.npy",
    # r"D:\桌面\随机噪声压制\shandong\数据\yxsn5cdpn_denoised.npy"
]
...
for i, file_path in enumerate(file_list):
    ...
    plt.xlabel("k / m$^{-1}$", fontsize=20, fontname = "Times New Roman")
    plt.ylabel("f / Hz", fontsize=20, fontname = "Times New Roman")
    plt.title(f"F-K(Denoised Result)", fontsize=24, fontname = "Times New Roman")
    ...
    # 保存图像
    save_dir = r"D:\桌面\随机噪声压制\shandong\code\可视化"
