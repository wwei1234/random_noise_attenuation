...
if __name__ == "__main__":
    ...
    data = normalize_patch(read_segy(r"D:\桌面\随机噪声压制\shandong\雷达\ldsn06.sgy"))[0]
    print(data.shape)
    dx = 10 # x方向嵌入维度
    rank = 2 # 固定秩参数
    ...
    # np.save(r"D:\桌面\随机噪声压制\shandong\数据\fx_denoised_yxsn5cdpn", denoised)
    # np.save(r"D:\桌面\随机噪声压制\shandong\数据\fx_noise_yxsn5cdpn", data-denoised)
